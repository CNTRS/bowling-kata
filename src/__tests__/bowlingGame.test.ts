...
describe("The Bowling Game", () => {
    ...
    it.skip("calculates the score for a given one spare and extra roll", () => {
        rollSpare()
        game.roll(5)
        rollMany(17, 0)
    ...
    it.skip("calculates the score for a given one strike and some extra rolls", () => {
        rollStrike()
        game.roll(2)
        game.roll(3)
        rollMany(16, 0)
    ...
    it.skip("calculates the score for a given perfect game", () => {
        rollMany(12, 10)

        expect(game.calculateTotalScore()).toBe(300)
    })

    it.skip("calculates the score for a given all spares game", () => {
    ...
    describe("Comparing scores of two all spares games with different spare patterns", () => {
        it.skip("calculates the score for a game with all 5-5 spares", () => {
        ...
        it.skip("calculates the score for a game with all 8-2 spares", () => {
    ...
    function rollMany(times: number, pins: number) {
        return Array.from({ length: times }).forEach(() => game.roll(pins))
    }
